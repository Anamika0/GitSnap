    ...
    <div id="home" className="bg-[#3f3f3f]">
      <div className="min-h-screen flex flex-col items-center justify-center max-w-7xl mx-auto">
        ...
        <main className="flex flex-1 flex-col md:flex-row items-center justify-center px-8 mt-1">
          ...
          <div className="flex-2 justify-center items-center md:w-full ">
            <Cube />
